...
// ./routes/event/roll.tsx

import type * as T from "react-router/route-module"

import type { Info as Parent0 } from "../../../+types/root.js"
import type { Info as Parent1 } from "./_layout.js"
import type { Info as Parent2 } from "./edit.js"

type Module = typeof import("../roll.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/event/roll"
  file: "./routes/event/roll.tsx"
  path: ":id/roll/"
  params: {"slug": string; "id": string} & { [key: string]: string | undefined }
  module: Module
