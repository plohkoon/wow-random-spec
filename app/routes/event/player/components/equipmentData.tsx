          ...
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {objectKeys.map((key: string) => {
                ...
                if (!item) return null;
                return (
                    <a href={`https://www.wowhead.com/item=${item.item_id}`} target="_blank">
                  <div
                    key={key}
                  ...
                  >
                    <div className="flex-shrink-0 mr-3 relative">
                      <div className="w-10 h-10 rounded border border-[#A0E7A0] overflow-hidden bg-black">
                        ...
                        /> */}
                        <Sword className="mx-auto" height={36} />
                      </div>
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      <span className="text-xs text-black dark:text-gray-400">{SLOT_LABELS[key] ?? key}</span>
                    </div>
                    <div className="flex-shrink-0">
                      <Badge className="bg-dark-brown dark:bg-black-light text-gray-400 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">
                        <IlvlDisplay ilvl={item.item_level} className="drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]"/>
                      </Badge>
                    </div>
                  </div>
                  </a>
